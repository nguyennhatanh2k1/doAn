...
export default function OrderModalUpdate(props) {
    ...
    //   useEffect(() => {
    //     setTotalHd(phiVanChuyen + totalSP);
    //   }, [phiVanChuyen, totalSP]);
    ///////////////////  Các hàm xử lí   /////////
    ...
    return (
        <Modal
            ...
            title={<h3 style={{
                ...
                marginBottom: "20px",
                fontWeight: "bold"
            }}>Cập nhật trạng thái {objectName}</h3>} open={isOpen} onCancel={handleCancel}
            onOk={() => console.log('hiihhihihih')} >
            <Form
            // disabled={true}
            >
                <Row gutter={40}>
                        ...
                        <Row gutter={20}>
                            <Col span={12}>
                                <Form.Item
                                    ...
                                    labelAlign='left'
                                >
                                    <Input allowClear size={inputSize}
                            ...
                            <Col span={12}>
                                ...
                                >
                                    <Select
                                        ...
                                        onChange={(value) => console.log(value, 'trạng thái')}
                                        style={{
                                            width: '100%',
                                        }}
                                        size={inputSize}
                            ...
                            <Col span={12}
                                ...
                                >
                                    <Input allowClear size={inputSize} placeholder={`Nhập số điện thoại`}
                                        // defaultValue={['a10', 'c12']}
                                    disabled
                                        onChange={(e) => console.log(e.target.value, 'số điện thoại')}
                                    />
                                </Form.Item>
                            </Col>
                            <Col span={12}
                                ...
                                >
                                    <Select
                                        ...
                                        // defaultValue={['a10', 'c12']}
                                    disabled
                                        onChange={(value) => console.log(value, 'phương thức thanh toán')}
                                        style={{
                                            width: '100%',
                                        }}
                                        size={inputSize}
                            ...
                            {/* <Col span={12}>
                                <Form.Item
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message: `Vui lòng chọn 1 Tỉnh/Thành phố !`,
                                        },
                                    ]}
                                    labelCol={{
                                        span: 24,
                                ...
                                >
                                    <Select
                                        ...
                                        // defaultValue={['a10', 'c12']}
                                        onChange={(value) => console.log(value, 'tỉnh')}
                                        style={{
                                            width: '100%',
                                        }}
                                        size={inputSize}
                            ...
                            <Col span={12}
                                ...
                                <Form.Item
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message: `Vui lòng chọn 1 Quận/Huyện !`,
                                        },
                                    ]}
                                    labelCol={{
                                        span: 24,
                                ...
                                >
                                    <Select
                                        ...
                                        // defaultValue={['a10', 'c12']}
                                        onChange={(value) => console.log(value, 'huyện')}
                                        style={{
                                            width: '100%',
                                        }}
                                        size={inputSize}
                            ...
                            <Col span={12}
                                ...
                                <Form.Item
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message: `Vui lòng chọn 1 Phường/Xã !`,
                                        },
                                    ]}
                                    labelCol={{
                                        span: 24,
                                ...
                                >
                                    <Select
                                        ...
                                        // defaultValue={['a10', 'c12']}
                                        onChange={(value) => console.log(value, 'xã')}
                                        style={{
                                            width: '100%',
                                        }}
                                        size={inputSize}
                            ...
                            <Col span={24}
                                ...
                                >
                                    <Input allowClear size={inputSize} placeholder={`Số nhà/ngõ/ngách hoặc vị trí dễ xác định...`}
                                        // defaultValue={['a10', 'c12']}
                                    disabled
                                        onChange={(e) => console.log(e.target.value, 'địa chỉ chi tiết')}
                                    />
                                </Form.Item>
                            </Col>
                            <Col span={24}
                                ...
                                >
                                    <Input size={inputSize}
                                        // value={'phí giao hàng ở đây'}
                                        defaultValue={'30000'}
                                        disabled
                                        suffix={'VND'}
                                        onChange={(e) => console.log(e.target.value, 'phí giao hàng')}
                                    />
                                </Form.Item>
                            </Col>
                        </Row>
                        ...
                        <Row>
                            ...
                            <Col span={24}>
                                <Form.Item label={<span style={{
                                    ...
                                    <TextArea rows={4} allowClear maxLength={2000} showCount placeholder='Nhập mô tả...' onChange={(e) => console.log(e.target.value)}
                                    disabled
                    ...
                    <Col span={12}>
                        ...
                        <Row>
                            <Table columns={cart_columns} pagination={paginationConfig} 
                            style={{ 
                                width: "100%",
                                pointerEvents: 'none',
                                opacity: 0.6
